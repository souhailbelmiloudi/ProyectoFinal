...
/**
 * La clase Yonuncaa representa una ventana de juego "Yo Nunca". Esta clase extiende JPanel.
 */
public class Yonuncaa extends JPanel {
	...
	/**
	 * Constructor de la clase Yonuncaa. Inicializa la interfaz grafica de la ventana.
	 */
	public Yonuncaa() {
