...
/**
 * La clase Principal representa la ventana principal del juego.
 * Extiende de JPanel y contiene la interfaz grafica y funcionalidades asociadas.
 */
public class Principal extends JPanel {
	 ...
	 * Configura la interfaz grafica y agrega funcionalidades a los componentes.
	 */
	public Principal() {
		setLayout(null);
