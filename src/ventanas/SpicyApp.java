...
/**
 * La clase SpicyApp representa la ventana principal de la aplicacion SpicyApp.
 * Extiende la clase JFrame y contiene varios paneles para diferentes modos de juego.
 */
...
public class SpicyApp extends JFrame{
	...
	Participantes p = new Participantes(); //Clase participantes
	
	//Conexión con la base de datos
	Conexion conx = new Conexion();
	Connection con = conx.conectar();
	/**
	 * Muestra el panel especificado en la pantalla.
	 *
	...
	/**
	 * Constructor de la clase SpicyApp.
	 * Configura la ventana principal y los diferentes paneles de juego.
	 */
	...
	public SpicyApp() {
		...
		chckbxNewCheckBox.addMouseListener(new MouseAdapter() {
			    ...
			    /**
			     * Method  para Reproduce la musica de fondo del juego.
			     */
			    private void playBackgroundMusic() {
			        try {
			        	// Ruta del archivo de músicagit
			            File musicFile = new File("../SpicyAPPproFinal/src/imagen/Musica_proyecto.mp3");
			    ...
			    /**
			     * Method  Detiene la reproduccion de la musica de fondo.
			     */
			    public void stopBackgroundMusic() {
			        if (player != null) {
			            player.close();
						playerThread.interrupt(); // Interrumpe la música (al pulsar)
			        }
			    }
		...
		//PANELES CON LA DESCRIPCION DE LOS MODOS
		...
		//MÉTODO PARA AÑADIR LOS PARTICIPANTES 
