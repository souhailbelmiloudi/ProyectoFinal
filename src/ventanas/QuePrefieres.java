...
/**
 * Esta clase representa el panel de juego "¿Que Prefieres".
 * Permite a los jugadores seleccionar entre dos opciones y muestra el porcentaje de preferencia de cada opción.
 */
...
public class QuePrefieres extends JPanel {
	...
	JProgressBar progressBarOP2 ;
	 ...
	 /**
     * Crea un nuevo panel "¿Que Prefieres?".
     * Configura los componentes gráficos y los anade al panel.
     */
	public QuePrefieres() {
		...
		progressBarOP2.setBounds(460, 305, 207, 98);
		add(progressBarOP2);
		...
		lblNext.setBounds(242, 436, 240, 58);
		add(lblNext);
	 ...
	 /**
     * Actualiza las preguntas mostradas en los campos de texto.
     * Obtiene preguntas aleatorias de la base de datos y las muestra correctamente en los campos de texto.
     */
	...
	// Método para actualizar la barra de progreso correspondiente a la opción seleccionada
	  /**
     * Actualiza las barras de progreso con el porcentaje de preferencia de cada opción.
     * Obtiene los votos de cada opción de la base de datos y calcula el porcentaje correspondiente.
     */
