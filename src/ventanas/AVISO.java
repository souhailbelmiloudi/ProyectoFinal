...
/**
 * La clase AVISO representa una ventana de aviso para invitar al usuario a crear una cuenta.
...
public class AVISO extends JFrame {
	...
	/**
	 * Constructor de la clase AVISO. Inicializa la interfaz grafica de la ventana.
	 */
	public AVISO() {
